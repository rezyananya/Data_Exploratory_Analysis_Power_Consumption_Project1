...
#Here I am plotting my second graph and name it plot2.png.
...
plot(Timecase, PowerConsumption$Global_active_power, xlab = '', ylab = 'Global Active Power (kilowatts)', type = 'l')
